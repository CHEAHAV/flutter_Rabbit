...
class HistoryEntry {
  ...
  factory HistoryEntry.fromJson(Map<String, dynamic> json) => HistoryEntry(
        ...
        mode: (json['mode'] as String) == 'mock' ? ExamMode.mock : ExamMode.practice,
...
class PartStat {
  ...
  final int answered;
  final int correct;
  const PartStat({required this.partId, required this.answered, required this.correct});
  ...
  PartStat addResult({required int answeredDelta, required int correctDelta}) => PartStat(
        partId: partId,
